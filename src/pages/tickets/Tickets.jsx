...
const CATEGORY_CONFIG = {
  ...
  sprzatanie: { Icon: SparkleIcon,       title: (loc) => `Zgłoszenie sprzątania – ${loc}` },
...
const INITIAL_TICKETS = [
  {
    ...
    description: 'Brak światła na 3. piętrze przy windzie. Miejsce: Klatka schodowa.',
  },
  {
    id: 2,
    number: 'ZG-2023-045',
...
const EXTRA_TICKETS = [
  {
    ...
    description: 'Winda zatrzymuje się między piętrami. Miejsce: Klatka schodowa.',
  },
  {
    id: 5,
    number: 'ZG-2023-027',
    ...
    description: 'Plamy na ścianie przy wejściu do bloku. Miejsce: Klatka schodowa.',
  },
  {
    id: 6,
    number: 'ZG-2023-021',
  ...
  },
  {
    ...
    description: 'Skrzynka nr 42 nie domyka się prawidłowo. Miejsce: Klatka schodowa.',
  },
  {
    id: 8,
    number: 'ZG-2023-009',
...
export default function Tickets() {
  ...
  const visibleTickets = showMore ? filteredTickets : filteredTickets.slice(0, 3);

  const activeCount = allDisplayTickets.filter((t) => ACTIVE_STATUSES.has(t.status)).length;
  ...
  return (
    <main className="tickets-wrapper">
      <header className="tickets-header">
        ...
        <p className="tickets-subtitle">Szybko dostarcz informacje o problemie w Twojej spółdzielni.</p>
      </header>
      ...
      <section className="tickets-card" aria-labelledby="heading-new">
        <div className="tickets-new__heading">
          ...
          <h2 className="tickets-new__title" id="heading-new">Nowe Zgłoszenie</h2>
        </div>
        ...
        <div className="tickets-form-body">
          ...
          <div className="tickets-form-columns">
            <div className="tickets-form-left">
              <div>
                <p className="tickets-field-label" id="label-category">WYBIERZ KATEGORIĘ</p>
                <div className="tickets-categories" role="group" aria-labelledby="label-category">
              ...
              <div>
                <label className="tickets-field-label" htmlFor="ticket-location">MIEJSCE</label>
            ...
            <div className="tickets-form-right">
              <label className="tickets-field-label" htmlFor="ticket-description">
                OPIS PROBLEMU
              </label>
              <textarea
      ...
      <section aria-labelledby="heading-my">
        <div className="tickets-list-header">
          <div>
            <h2 className="tickets-section-title" id="heading-my">Twoje Zgłoszenia</h2>
            <p className="tickets-section-subtitle">Aktualnie pracujemy nad rozwiązaniem Twoich interwencji.</p>
          </div>
          <div className="tickets-filters" role="group" aria-label="Filtruj zgłoszenia">
            <button
              type="button"
              className={`tickets-filter-btn${activeFilter === 'all' ? ' tickets-filter-btn--active' : ''}`}
              onClick={() => { setActiveFilter('all'); setShowMore(false); }}
            ...
            <button
              ...
              onClick={() => { setActiveFilter('active'); setShowMore(false); }}
              ...
              >
                ...
                <div className="tickets-item__content">
                  <div className="tickets-item__meta">
                    <span className="tickets-item__number">#{ticket.number}</span>
                    <span className="tickets-item__dot" aria-hidden="true">•</span>
                    <span className="tickets-item__date">{ticket.date}</span>
                    <span className={`tickets-item__badge tickets-item__badge--${config.modifier}`}>
                      {ticket.status}
                    </span>
                  </div>
      ...
      {/* ── Nagłe Przypadki ── */}
      <section className="tickets-emergency" aria-labelledby="heading-emergency">
        <div className="tickets-emergency__content">
          ...
          <h2 className="tickets-emergency__title" id="heading-emergency">
            Potrzebujesz pomocy pilnej?
          </h2>
          <p className="tickets-emergency__desc">
            W przypadku awarii zagrażającej życiu lub mieniu, prosimy o bezpośredni
            kontakt telefoniczny z całodobowym pogotowiem technicznym.
          </p>
