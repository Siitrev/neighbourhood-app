        ...
        <div className="form-column">
          <form className="register-card" onSubmit={handleRegister}>
            ...
            <div className="input-group">
              ...
              <div className="input-wrapper">
                <svg className="input-icon-left" width="15" height="12" viewBox="0 0 15 12" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
            ...
            <div className="input-group">
              ...
              <div className="input-wrapper">
                <svg className="input-icon-left" width="12" height="16" viewBox="0 0 12 16" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
